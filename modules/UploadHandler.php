...
class UploadHandler
{
	...
	$mysqli->query("insert into slide set name = '".$file->name."', priority = ".($result->num_rows + 1).", full_tag = '<img src=\"slide_images/".$file->name."\"/>', created_at = '".$mysqldate."'");
	...
	$mysqli->query("delete from slide where name ='".$file_name."'");
